 ...
 *    ABC: tem nem oque falar, melhores tutoriais e exemplos de codigo, percursor da wave surfing, god god
 *	}
 *
 * Usando pacotes personalizados de {
 *		Nat, David Alves - para as funcoes de desenho do debugger - package ur4n0.graph.BHDrawer // ia implementar mas no deu tempo aaa
 * }
-->
